...
<li>
    ...
    <ul class="collapse list-unstyled
        ...
        @elseif(request()->is('admin/attribute/*/manage') && request()->input('type') == 'childcategory')
          show
        @elseif(request()->is('admin/category-sliders*'))
          show
        @endif"
        ...
        <li class="@if (request()->is('admin/category-sliders*')) active @endif">
            <a href="{{ route('category-sliders.index') }}"><span>{{ __('Category Sliders') }}</span></a>
        </li>
    </ul>
</li>
...
{{-- TEMP: Commerce Settings (Admin access) --}}
@if(auth()->guard('admin')->check())
<li>
    <a href="{{ route('admin-commerce-settings') }}">
        <span>{{ __('Commerce Settings') }}</span>
        <span class="badge badge-warning ml-1">TEMP</span>
    </a>
</li>
@endif
    </ul>
