                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="theme" class="input-field">
                                            <option value="all" {{ ($data->theme ?? 'all') === 'all' ? 'selected' : '' }}>
                                                {{ __('All Themes') }}
                                            </option>
                                            <option value="theme1" {{ ($data->theme ?? '') === 'theme1' ? 'selected' : '' }}>
                                                {{ __('Theme 1') }}
                                            </option>
                                            <option value="theme2" {{ ($data->theme ?? '') === 'theme2' ? 'selected' : '' }}>
                                                {{ __('Theme 2') }}
                                            </option>
                                            <option value="theme3" {{ ($data->theme ?? '') === 'theme3' ? 'selected' : '' }}>
                                                {{ __('Theme 3') }}
                                            </option>
                                        </select>
                                    </div>
