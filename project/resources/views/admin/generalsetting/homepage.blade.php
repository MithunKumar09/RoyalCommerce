                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area p-4">
                            ...
                            <form action="{{ route('admin-gs-update-theme-colors') }}" method="POST">
                                @csrf
                                <div class="row justify-content-center">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>{{ __('Theme 1 Color') }}</label>
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" name="theme1_color"
                                                    value="{{ $gs->theme1_color ?? $gs->colors }}"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>{{ __('Theme 2 Color') }}</label>
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" name="theme2_color"
                                                    value="{{ $gs->theme2_color ?? $gs->colors }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>{{ __('Theme 3 Color') }}</label>
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" name="theme3_color"
                                                    value="{{ $gs->theme3_color ?? $gs->colors }}"
                                                    class="form-control cp" />
                                                <span class="input-group-addon"><i></i></span>
                                            </div>
                                        </div>
