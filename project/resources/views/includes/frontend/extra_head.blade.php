...
@php
    $activeThemeColor = isset($themeColor) && $themeColor ? $themeColor : $gs->colors;
@endphp
<link rel="stylesheet"
    href="{{ asset('assets/front/css/styles.php?color=' . str_replace('#', '', $activeThemeColor) . '&header_color=' . $gs->header_color) }}">
