...
class FrontBaseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->themeColor = $this->resolveThemeColor($this->gs->theme ?? null);
        view()->share('themeColor', $this->themeColor);
    ...
    protected function resolveThemeColor(?string $theme): string
    {
        if (!$theme) {
            return $this->gs->colors ?? '#424a4d';
        }

        $field = $theme . '_color';
        if (isset($this->gs->$field) && !empty($this->gs->$field)) {
            return $this->gs->$field;
        }
