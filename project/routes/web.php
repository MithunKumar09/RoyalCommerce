...
Route::prefix('admin')->group(function () {
    ...
    //------------ ADMIN CATEGORY SLIDER SECTION ------------
    // Admin auth is already enforced by AdminBaseController (auth:admin).
    Route::resource('category-sliders', \App\Http\Controllers\Admin\CategorySliderController::class);
    Route::get('category-sliders/status/{id}/{status}', [\App\Http\Controllers\Admin\CategorySliderController::class, 'status']);
    //------------ ADMIN CATEGORY SLIDER SECTION ENDS ------------
    ...
    Route::group(['middleware' => 'permissions:products'], function () {
        ...
        Route::post('/products/media/360/upload/{id}', 'Admin\ProductController@media360Upload')->name('admin-prod-media-360-upload');
        Route::get('/products/media/360/manifest/{id}', 'Admin\ProductController@media360Manifest')->name('admin-prod-media-360-manifest');
        Route::post('/products/media/360/delete/{id}', 'Admin\ProductController@media360Delete')->name('admin-prod-media-360-delete');
    ...
    Route::post('/general-settings/update/theme-colors', 'Admin\GeneralSettingController@updateThemeColors')->name('admin-gs-update-theme-colors');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    // Friendly alias for Theme 4 home (keeps /?theme=theme4 working permanently)
    Route::get('/Home', 'Front\FrontendController@index')->name('front.home');
